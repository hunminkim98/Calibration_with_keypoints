...
def create_P_all(all_best_results, Ks):
    ...
    for camera_key, params in all_best_results.items():
        K = params['K2']
        R = params['R']
        t = params['t']
...
def triangulate_points(P_all, all_keypoints):
    """
...
print(f"sum of all_keypoints: {sum(len(keypoints) for keypoints in all_keypoints)}")
# for i in all_keypoints:
#     print(i)
print(f"all_best_results: {all_best_results}")
P_all = create_P_all(all_best_results, Ks)

print(f"P_all: {P_all}")
triangulated_points = triangulate_points(P_all, all_keypoints)
print(f"sum of triangulated: {sum(len(keypoints) for keypoints in triangulated_points)}")

#plot triangulated points
plot_3d_points(triangulated_points)



# for i in triangulated_points:
#     print(i)
